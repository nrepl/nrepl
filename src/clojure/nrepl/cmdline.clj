...
(defn help
  ...
  --tls-keys-file FILE        Enable TLS, reading the CA certificate, certificate and private key from FILE. Applies both when starting a server and when using --connect. See the TLS section of the manual for details on generating the keys.
  --tls-keys-str KEYS         Same as --tls-keys-file, but the certificates and private key are passed directly as a string.
