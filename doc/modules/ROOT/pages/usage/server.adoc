...
your app and modify its behaviour or run code on the remote host.  And
unless you're specifying a suitable `:auth-wrapper`, then the same
access is always available for other local users.
