...
[source,shell]
----
$ clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version "1.2.0"}
...
[source,shell]
----
$ clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version "1.2.0"} com.cemerick/pomegranate {:mvn/version "1.2.0"}}}' -M -m nrepl.cmdline --interactive
network-repl
Clojure 1.9.0
