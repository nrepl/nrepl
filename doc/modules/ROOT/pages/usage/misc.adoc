...
[source,shell]
----
$ clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version "1.5.1"}
...
[source,shell]
----
$ clj -Sdeps '{:deps {nrepl/nrepl {:mvn/version "1.5.1"} com.cemerick/pomegranate {:mvn/version "1.2.25"}}}' -M -m nrepl.cmdline --interactive
network-repl
Clojure 1.9.0
