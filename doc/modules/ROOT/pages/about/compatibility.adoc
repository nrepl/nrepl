...
nREPL targets Clojure 1.8+. As Clojure doesn't have the concept of supported releases
...
from the
https://clojure.org/news/2024/06/02/state-of-clojure-2024[State of
...
Below you can find the official compatibility matrix for nREPL.
