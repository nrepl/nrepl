...
nREPL is licensed under the link:https://www.eclipse.org/legal/epl-v10.html[Eclipse Public License].
...
but this was changed with nREPL 0.3. You can find the re-licensing discussion link:https://github.com/nrepl/nrepl/issues/2[here].
