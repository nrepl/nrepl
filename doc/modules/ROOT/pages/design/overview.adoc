= Overview
:page-aliases: design.adoc
:description: How nREPL is put together: messages, transports, handlers, middleware and sessions.
...
A partial `clojure.spec` for nREPL messages is provided as `nrepl.spec`. This covers
